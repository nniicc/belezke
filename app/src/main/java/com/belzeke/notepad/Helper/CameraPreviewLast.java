...
public class CameraPreviewLast extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraPreviewLast(Context context, Camera camera) {
        super(context);
        mContext = context;
        mCamera = camera;
        mHolder = getHolder();
    ...
    public CameraPreviewLast(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CameraPreviewLast(Context context, AttributeSet attrs, int defStyleAttr) {
